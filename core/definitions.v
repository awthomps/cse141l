...
`define kBRLU  16'b01011_?????_?????? // BRLU
...
`define kSMS0  16'b11100_?????_?????? // 28 SMS0 (small sig 0)
`define kSMS1  16'b11101_?????_?????? // 29 SMS1 (small sig 1)
// 30
// 31
